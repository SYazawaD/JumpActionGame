package jp.techacademy.shouta.yuzawa.jumpactiongame
...
class GameScreen(private val mGame: JumpActionGame) : ScreenAdapter() {
    ...
    //敵衝突時の音設定(音楽：魔王魂)
    private val sound = Gdx.audio.newSound(Gdx.files.internal("GameOver.mp3"))
    //ゲームクリア時の音設定(音楽：魔王魂)
    private val sound2 = Gdx.audio.newSound(Gdx.files.internal("GameClear.mp3"))
    ...
    init {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.shouta.yuzawa.jumpactiongame") // ←追加する
    ...
    private fun createStage() {
        ...
        val enemyTexture = Texture("bone_ape.png")
        ...
        // yをゴールの高さ-5まで足していく。その間にランダムで、StepとStarを配置する
        ...
        // ゴールの高さ設定
        val maxJumpHeight2 = Player.PLAYER_JUMP_VELOCITY * Player.PLAYER_JUMP_VELOCITY / (2 * -GRAVITY)
